...
weather=input("What is the weather like? (Sunny/Rainy/Snowy/Cloudy) :").strip().lower()
book_due=input("Do you have a book return? (yes/no) :").strip().lower()

print()
print(f"=== Your Library Visit Plan for {day} ===")
print("-" * 35)
...
if weather == "rainy" or weather == "cloudy":
    print("Weather tip  : Carry an umbrealla if you are going to the library.")

if not book_due == "yes":
    print("Book Status  : No book return needed today. You can browse new books.")

if weather == "rainy" and book_due == "yes":
    print("Best plan   : Visit the library carefully and return your books on time.")
elif weather == "sunny" and book_due == "yes" and not (day in ("Saturday", "Sunday")):
    print("Best plan   : Stop by the library after school and return your books on time.")
